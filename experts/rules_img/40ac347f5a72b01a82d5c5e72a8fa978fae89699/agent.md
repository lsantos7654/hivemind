...
Repository source at `{CACHE_DIR}/repos/rules_img`.
If not present, run: `hivemind enable rules_img`

**External Documentation:**
Additional crawled documentation may be available at `{CACHE_DIR}/external_docs/rules_img/`.
...
2. **SEARCH SOURCE CODE** - Use Grep and Glob to find relevant code at `{CACHE_DIR}/repos/rules_img/`:
...
- **Verification**: When uncertain, read the actual source code at `{CACHE_DIR}/repos/rules_img/`
