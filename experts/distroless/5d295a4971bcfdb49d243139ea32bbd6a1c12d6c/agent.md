...
Repository source at `{CACHE_DIR}/repos/distroless`.
If not present, run: `hivemind enable distroless`

**External Documentation:**
Additional crawled documentation may be available at `{CACHE_DIR}/external_docs/distroless/`.
...
2. **SEARCH SOURCE CODE** - Use Grep and Glob to find relevant code at `{CACHE_DIR}/repos/distroless/`:
...
- **Verification**: When uncertain, read the actual source code at `{CACHE_DIR}/repos/distroless/`
