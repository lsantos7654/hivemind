...
Repository source at `{CACHE_DIR}/repos/toolong`.
If not present, run: `hivemind enable toolong`

**External Documentation:**
Additional crawled documentation may be available at `{CACHE_DIR}/external_docs/toolong/`.
...
2. **SEARCH SOURCE CODE** - Use Grep and Glob to find relevant code at `{CACHE_DIR}/repos/toolong/`:
...
- **Verification**: When uncertain, read the actual source code at `{CACHE_DIR}/repos/toolong/`
