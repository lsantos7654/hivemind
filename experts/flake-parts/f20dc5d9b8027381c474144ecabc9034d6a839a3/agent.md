...
Repository source at `{CACHE_DIR}/repos/flake-parts`.
If not present, run: `hivemind enable flake-parts`

**External Documentation:**
Additional crawled documentation may be available at `{CACHE_DIR}/external_docs/flake-parts/`.
...
2. **SEARCH SOURCE CODE** - Use Grep and Glob to find relevant code at `{CACHE_DIR}/repos/flake-parts/`:
...
- **Verification**: When uncertain, read the actual source code at `{CACHE_DIR}/repos/flake-parts/`
