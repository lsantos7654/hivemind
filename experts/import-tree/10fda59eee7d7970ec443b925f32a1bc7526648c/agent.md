...
Repository source at `{CACHE_DIR}/repos/import-tree`.
If not present, run: `hivemind enable import-tree`

**External Documentation:**
Additional crawled documentation may be available at `{CACHE_DIR}/external_docs/import-tree/`.
...
2. **SEARCH SOURCE CODE** - Use Grep and Glob to find relevant code at `{CACHE_DIR}/repos/import-tree/`:
...
- **Verification**: When uncertain, read the actual source code at `{CACHE_DIR}/repos/import-tree/`
