...
Repository source at `{CACHE_DIR}/repos/metaflow`.
If not present, run: `hivemind enable metaflow`

**External Documentation:**
Additional crawled documentation may be available at `{CACHE_DIR}/external_docs/metaflow/`.
...
2. **SEARCH SOURCE CODE** - Use Grep and Glob to find relevant code at `{CACHE_DIR}/repos/metaflow/`:
...
- **Verification**: When uncertain, read the actual source code at `{CACHE_DIR}/repos/metaflow/`
