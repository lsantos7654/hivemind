...
- Summary: {EXPERTS_DIR}/rules_testing/HEAD/summary.md
- Code Structure: {EXPERTS_DIR}/rules_testing/HEAD/code_structure.md
- Build System: {EXPERTS_DIR}/rules_testing/HEAD/build_system.md
- APIs: {EXPERTS_DIR}/rules_testing/HEAD/apis_and_interfaces.md

## Source Access

Repository source at `{CACHE_DIR}/repos/rules_testing`.
If not present, run: `hivemind enable rules_testing`

**External Documentation:**
Additional crawled documentation may be available at `{CACHE_DIR}/external_docs/rules_testing/`.
...
1. **READ KNOWLEDGE DOCS FIRST** - ALWAYS start by reading relevant files from:
   - `{EXPERTS_DIR}/rules_testing/HEAD/summary.md` - Repository overview
   - `{EXPERTS_DIR}/rules_testing/HEAD/code_structure.md` - Code organization
   - `{EXPERTS_DIR}/rules_testing/HEAD/build_system.md` - Build and dependencies
   - `{EXPERTS_DIR}/rules_testing/HEAD/apis_and_interfaces.md` - APIs and usage patterns

2. **SEARCH SOURCE CODE** - Use Grep and Glob to find relevant code at `{CACHE_DIR}/repos/rules_testing/`:
...
- **Verification**: When uncertain, read the actual source code at `{CACHE_DIR}/repos/rules_testing/`
