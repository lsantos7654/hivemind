...
Repository source at `{CACHE_DIR}/repos/MiroFish`.
If not present, run: `hivemind enable MiroFish`

**External Documentation:**
Additional crawled documentation may be available at `{CACHE_DIR}/external_docs/MiroFish/`.
...
2. **SEARCH SOURCE CODE** - Use Grep and Glob to find relevant code at `{CACHE_DIR}/repos/MiroFish/`:
...
- **Verification**: When uncertain, read the actual source code at `{CACHE_DIR}/repos/MiroFish/`
