...
Repository source at `{CACHE_DIR}/repos/bazel-skylib`.
If not present, run: `hivemind enable bazel-skylib`

**External Documentation:**
Additional crawled documentation may be available at `{CACHE_DIR}/external_docs/bazel-skylib/`.
...
2. **SEARCH SOURCE CODE** - Use Grep and Glob to find relevant code at `{CACHE_DIR}/repos/bazel-skylib/`:
...
- **Verification**: When uncertain, read the actual source code at `{CACHE_DIR}/repos/bazel-skylib/`
