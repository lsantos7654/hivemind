...
- [X] update wording for `Update All` should only update active agents only
...
- [-] under hivemind list what is the purpose of agent and status, they are 1 to 1, isn't this redundant?
...
╰─❯ hivemind enable core
  ! core: not in repos.json, skipping clone
  ✓ core: agent symlink created
✓ Enabled: core
