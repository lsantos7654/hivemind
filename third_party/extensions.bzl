...
_OPENCODE_DEP_PATCHES = [
    ...
    "0025-fix-add-types-field-to-plugin-package.json-for-tsgo-.patch",
    "0027-fix-add-types-condition-to-plugin-exports-for-tsgo-r.patch",
]
...
_OPENCODE_CODE_PATCHES = [
    "0005-Rewrite-the-TUI-exit-Continue-suggestion-to-hivemind.patch",
    "0006-Rebrand-the-OPENCODE-wordmark-TUI-logo-to-HIVEMIND.patch",
    "0007-Inline-connection-indicator-into-home-sidebar-footer.patch",
    ...
    "0011-Per-session-inbox-with-deferred-delivery.patch",
    "0012-Session.fork-accepts-optional-parentID-and-permissio.patch",
    "0013-Task-tool-accepts-source_session_id.patch",
    "0014-Background-Task-mode-and-lifecycle-Task-tool.patch",
    "0015-TUI-session_footer-slot-dual-slot-home-footer-plugin.patch",
    "0016-Switch-HTTP-listener-to-native-Bun.serve.patch",
    "0017-Per-client-WebSocket-presence-and-focus-tracking.patch",
    "0018-Extend-reload-agents-to-invalidate-Skill-and-Command.patch",
    "0019-TUI-SSE-loop-catch-transient-errors-and-reconnect.patch",
    "0020-Session-metadata-column.patch",
    "0021-File-write-hook-hivemind-memory-compaction-auto-spaw.patch",
    "0022-Ephemeral-subagent-sessions.patch",
    "0023-Broadcast-reload-agents-notification-over-presence-W.patch",
    "0024-fix-stabilize-engine-typecheck-autoshare-migration-f.patch",
    "0026-fix-remaining-tsgo-errors-port-assertions-slot-types.patch",
    "0028-fix-add-session_footer-slot-to-TuiHostSlotMap.patch",
    "0029-fix-agent-reloadAll-typed-boundary-revert-footer-slo.patch",
    "0030-fix-make-Agent.reload-optional-on-Bus.Service.patch",
    "0031-fix-use-serviceOption-isSome-pattern-in-Agent.reload.patch",
    "0032-fix-tsconfig-paths-for-opencode-ai-plugin-to-resolve.patch",
    "0033-fix-add-baseUrl-to-tsconfig-for-paths-resolution.patch",
    "0034-Revert-remove-tsconfig-paths-baseUrl-tsgo-rejects-bo.patch",
    "0035-fix-update-permission-fromConfig-test-assertions-for.patch",
]
