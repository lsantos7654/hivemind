...
_OPENCODE_CODE_PATCHES = [
    "0006-Rewrite-the-TUI-exit-Continue-suggestion-to-hivemind.patch",
    "0007-Rebrand-the-OPENCODE-wordmark-TUI-logo-to-HIVEMIND.patch",
    "0008-Inline-connection-indicator-into-home-sidebar-footer.patch",
    ...
    "0012-Per-session-inbox-with-deferred-delivery.patch",
    "0013-Session.fork-accepts-optional-parentID-and-permissio.patch",
    "0014-Task-tool-accepts-source_session_id.patch",
    "0015-Background-Task-mode-and-lifecycle-Task-tool.patch",
    "0016-TUI-session_footer-slot-dual-slot-home-footer-plugin.patch",
    "0017-Switch-HTTP-listener-to-native-Bun.serve.patch",
    "0018-Per-client-WebSocket-presence-and-focus-tracking.patch",
    "0019-Extend-reload-agents-to-invalidate-Skill-and-Command.patch",
    "0020-TUI-SSE-loop-catch-transient-errors-and-reconnect.patch",
    "0021-Session-metadata-column.patch",
    "0022-File-write-hook-hivemind-memory-compaction-auto-spaw.patch",
    "0023-Ephemeral-subagent-sessions.patch",
