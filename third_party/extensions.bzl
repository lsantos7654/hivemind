...
_OPENCODE_DEP_PATCHES = [
    ...
    "0006-sdk-gen-inbox-list-and-queue-metadata.patch",
]
...
_OPENCODE_CODE_PATCHES = [
    "0007-This-is-a-combination-of-2-commits.-This-is-the-1st-.patch",
    "0008-This-is-a-combination-of-3-commits.-This-is-the-1st-.patch",
    "0009-Non-destructive-agent-reload-endpoint.patch",
    "0010-Hardened-opencode-config-defaults.patch",
    "0011-Bake-bash.sudo-deny-into-Permission.fromConfig.patch",
    "0012-Rewrite-the-TUI-exit-Continue-suggestion-to-hivemind.patch",
    "0013-Task-tool-accepts-source_session_id.patch",
    "0014-TUI-session_footer-slot-dual-slot-home-footer-plugin.patch",
    "0015-Switch-HTTP-listener-to-native-Bun.serve.patch",
    "0016-Per-client-WebSocket-presence-and-focus-tracking.patch",
    "0017-Extend-reload-agents-to-invalidate-Skill-and-Command.patch",
    "0018-TUI-SSE-loop-catch-transient-errors-and-reconnect.patch",
    "0019-Session-metadata-column.patch",
    "0020-Broadcast-reload-agents-notification-over-presence-W.patch",
    "0021-fix-stabilize-engine-typecheck-autoshare-migration-f.patch",
    "0022-Capture-git-branch-and-remote-URL-in-session-metadat.patch",
    "0023-fix-inline-git-info-read-into-createNext-drop-broken.patch",
    "0024-fix-rerender-subagent-count-pill-on-session-focus-ch.patch",
    "0025-test-add-scenario-test-stubs-Stage-10-Stage-11-TODO.patch",
    "0026-fix-resolve-agent-from-session-history-on-inbox-prom.patch",
    "0027-fix-use-git-CLI-instead-of-raw-.git-filesystem-reads.patch",
    ...
    "0032-feat-auto-attribute-MCP-inbox-sends-to-caller-sessio.patch",
]
