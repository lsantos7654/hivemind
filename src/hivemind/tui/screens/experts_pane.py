...
from hivemind.tui.widgets import ExpertTable, SearchBar
from hivemind.tui.widgets.base_pane import BasePane

if TYPE_CHECKING:
    from textual.app import ComposeResult

    from hivemind.models import CancellationToken
...
class ExpertsPane(BasePane):
    ...
    def action_delete(self) -> None:
        ...
        async def _do_delete(confirmed: bool) -> None:
            if confirmed:
                from hivemind.tui.operations import delete_expert_async_op
    ...
    async def _add_expert_wrapper(self, url: str):
        from hivemind.tui.operations import add_expert_async
